CREATE  PROCEDURE [adw].[Load_Pdw_MasterLoad_CopDevoted] (@QMDate DATE, @ClientKey INT,@DataDate DATE)
AS
	--DECLARE @DataDate DATE '2020-06-08'
	--DECLARE @QMDate DATE = '2020-06-08';
...
BEGIN
	...
	EXEC [adw].[pdwCOP_Devoted] @QMDate,@ClientKey
	SET @StartTime = GETDATE();	   
