...
--	and 
 ...
 --   IF @RecordExist = 0
	...
	BEGIN
    -- Insert statements 
    INSERT INTO [adi].[DHTX_MembershipEnrollment]
    (
 ...
 VALUES   (
	...
	then NULL
	Else CONVERT(date,@Member_Date_Of_Birth)
	END ,
	@Member_Address_Line_1 ,
	@Member_Address_Line_2 ,
	@Member_City  ,
	...
	END ,
    CASE WHEN @PCP_End_Date  = ''
	then NULL
	Else CONVERT(date, @PCP_End_Date )
	END ,
	CASE WHEN @Coverage_Effective_Date = ''
	then NULL
	Else CONVERT(date, @Coverage_Effective_Date)
	END ,
	CASE WHEN 	@Coverage_End_Date  = ''
	then NULL
	Else CONVERT(date, 	@Coverage_End_Date)
	END ,
	@Devoted_Contracting_Group_ID  ,
	@Devoted_Contracting_Group_Name  ,
	@Member_Status  ,
