...
BEGIN
 ...
 --   IF @RecordExist = 0
   ...
   -- IF (@Devoted_Member_ID != '' and @SrcFileName NOT LIKE '%DisenrollmentReport%')
	BEGIN
    -- Insert statements 
    INSERT INTO [adi].[DHTX_EligibilityMonthly]
    ( 
...
--	@LastUpdatedDatedatetime] ,
	...
	@MemberLanguage   ,
	@MemberGender   ,
	CASE WHEN @MemberDeathDate  = ''
	THEN NULL
	ELSE CONVERT(DATE,@MemberDeathDate)
	END,
	@PlanName   ,
	@CMSContractPBP   ,
	@DualEligibleStatus   ,
	...
	@NewThisMonth   ,
	@MonthEndStatus,   
	CASE WHEN @EnrollmentStartDate = ''
	THEN NULL
	ELSE CONVERT(DATE, @EnrollmentStartDate)
	END,
	CASE WHEN @EnrollmentEndDate = ''
	THEN NULL
	ELSE CONVERT(DATE, @EnrollmentEndDate)
	END,	
	CASE WHEN @PCPStartDate = ''
	THEN NULL
	ELSE CONVERT(DATE, @PCPStartDate)
	END,	
	CASE WHEN @PCPEndDate = ''
	THEN NULL
	ELSE CONVERT(DATE, @PCPEndDate)
	END,	
	@DevotedPCPGroupID,
	@LineOfBusiness,
